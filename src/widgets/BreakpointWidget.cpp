    ...
    , ui(new Ui::BreakpointWidget)
{
    ...
    ui->breakpointTreeView->setModel(static_cast<QAbstractItemModel *>(breakpointProxyModel));
    ...
    connect(
        ui->addBreakpoint, &QAbstractButton::clicked, this, &BreakpointWidget::addBreakpointDialog);
