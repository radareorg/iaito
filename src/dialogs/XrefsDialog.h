...
public:
    ...
    /**
     * @brief Initializes toModel and fromModel with the details about the
     * references to the specified local variable 'nameOfVariable'.
     * @param nameOfVarible Name of the local variable for which the references
