...
private:
    ...
    /**
     * @brief This function creates the list with the different options shown in
     * the selector for anal.in
     */
    void createAnalInOptionsList();

private slots:
    /**
     * @brief A slot to display the options in the dialog according to the
     * current anal.* configuration
     */
    void updateAnalOptionsFromVars();

    /**
     * @brief A generic slot to handle the simple cases where a checkbox is
     * toggled while it's only responsible for a single independent boolean
     * configuration eval.
    ...
    /**
     * @brief A slot to update the value of anal.in when a different option is
     * selected
    ...
    /**
     * @brief A slot to update the value of anal.ptrdepth when a new value is
     * selected
    ...
    /**
     * @brief slot to update the value of anal.prelude when a new value is
     * introduced in the corresponding textbox
