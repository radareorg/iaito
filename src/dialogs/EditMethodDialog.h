...
public:
    /**
     * @param classFixed whether the user should be able to change the class. If
     * false, a QComboBox will be shown, otherwise a plain QLabel.
     */
     ...
     * @param className initial class name, will be overwritten if the user
     * changed the class
    ...
    static void newMethod(
        QString className = nullptr, const QString &meth = QString(), QWidget *parent = nullptr);
...
private:
    ...
    /**
     * This will only be used when the dialog was created with classFixed = true
     * in order to remember the class name.
     */
    QString fixedClass;
