...
{
    QUrl url("https://api.github.com/repos/radareorg/r2cutter/releases/latest");
...
void UpdateWorker::download(QString filename, QString version)
{
    ...
    QUrl url(QString("https://github.com/radareorg/r2cutter/releases/"
...
void UpdateWorker::showUpdateDialog(bool showDontCheckForUpdatesButton)
{
    ...
    mb.setText(tr("There is an update available for Cutter.<br/>")
               ...
               + QString("<a href=\"https://github.com/radareorg/r2cutter/releases/tag/v%1\">"
                         "https://github.com/radareorg/r2cutter/releases/tag/v%1</a><br/>").arg(latestVersion.toString())
